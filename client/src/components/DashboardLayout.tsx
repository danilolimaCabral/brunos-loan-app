...
import { LayoutDashboard, LogOut, PanelLeft, Users, DollarSign, Shield, UserCheck, Bot } from "lucide-react";
...
const menuItems = [
  ...
  { icon: UserCheck, label: "Usuários Online", path: "/usuarios-online" },
...
export default function DashboardLayout({
  ...
  // Usar dados do localStorage ao invés de OAuth
